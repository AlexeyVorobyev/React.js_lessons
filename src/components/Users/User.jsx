...
export const User = ({data, onClickInvite, id}) => {
    const [isInvited, setInvited] = React.useState(false)
    ...
    return (<li>
        ...
        <img className="action" src={isInvited ? '/assets/minus.svg':'/assets/plus.svg'} alt="Action" 
            onClick={() => {
